...
**fpctl dump ci** [**-out** *fichier*]

**fpctl dump restaurer** [**-fichier** *fichier*]
...
**fpctl dump ci** recopie chaque matvue et chaque TableDirecte dans un
schéma jetable (**ci**) sous forme de tables ordinaires, colonnes d'un
type énuméré propre à **core** (**mandate_type**, **organization_kind**...)
converties en **text** au passage, puis exporte ce seul schéma avec
**pg_dump -Fc**. Deux raisons empêchent de dumper **mv** directement :
...
**fpctl dump restaurer** restaure ce fichier dans la base ciblée par
...
1. **fpctl dump ci** puis **fpctl dump restaurer** dans une base de test.
...
**-fichier** *fichier*
:   (dump restaurer) Fichier à restaurer. Défaut : **ci.dump**.

# VOIR AUSSI

**fpctl**(1), **fpctl-list**(1), **fpctl-ingest**(1), **fpctl-build**(1)
