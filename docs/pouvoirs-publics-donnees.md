...
> Cette note répond directement à une question posée sur la masse salariale
> des fonctionnaires au sens large — anciens présidents, gouvernement,
> députés, sénateurs — avec une réponse plus étroite que la question : ce qui
> est réellement mesurable en open data, ce sont les **dotations
> budgétaires** de la mission « Pouvoirs publics », pas une rémunération
> individuelle. C'est délibéré, et cohérent avec le reste du projet : jamais
> de donnée nominative de rémunération sans source qui la publie.
...
## 2. Ce que cette dotation ne dit pas — et pourquoi ce n'est pas chargé

**La question posée visait plus précisément que ce que l'open data permet.**
