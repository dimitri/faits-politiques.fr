...
| [DECP consolidées](https://www.data.gouv.fr/datasets/donnees-essentielles-de-la-commande-publique-consolidees-format-tabulaire) | Attributions de marchés, acheteur, titulaire, montant | Marché | 2018 → | Quotidienne | Parquet, CSV | Licence Ouverte | **chargé** (`core.public_contract`, 2 104 142 lignes, 15/09/2026) |
