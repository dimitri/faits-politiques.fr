...
|---|---|
| [decisions.md](decisions.md) | **Le journal des décisions, D-001 à D-070.** Toute affirmation de ce projet doit pouvoir s'y rattacher, y compris les erreurs corrigées. |
