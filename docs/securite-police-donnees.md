...
|---|---:|---:|
| Police nationale | 12,93 | 13,37 |
| Gendarmerie nationale | 10,39 | 10,93 |
| Sécurité civile | 0,73 | 0,83 |
| Sécurité et éducation routières | 0,11 | 0,08 |
| **Mission Sécurités (total)** | **24,17** | **25,22** |

**Ce sont des crédits de paiement (CP) votés au PROJET de loi de finances**,
pas la loi de finances initiale (LFI) telle qu'adoptée après débat
parlementaire, ni l'exécution réelle — le même piège voté/exécuté déjà posé
dans [docs/budget-donnees.md](budget-donnees.md) § 2. Les autorisations
...
|---|---:|---:|
| 2 — Personnel | 11,21 | 11,61 |
| 3 — Fonctionnement | 1,24 | 1,26 |
| 5 — Investissement | 0,45 | 0,46 |
| 6 — Intervention | 0,03 | 0,03 |

**87 % du budget de la police nationale est du personnel** (titre 2) en 2025 —
fonctionnement, investissement et intervention réunis ne pèsent que 13 %.
C'est le fait le plus structurant de ce budget : la quasi-totalité de ce que
vote le Parlement pour la police nationale finance des salaires et charges de
personnel, pas de l'équipement ou des opérations.

Par action (2025, crédits de paiement) :

| Action | Md€ |
|---|---:|
| Sécurité et paix publiques | 4,03 |
| Police judiciaire | 3,17 |
| Commandement, ressources humaines et logistique | 2,71 |
| Ordre public et protection de la souveraineté | 1,81 |
...
- Effectifs (ETPT) de la police nationale : aucun jeu de données ouvert
  identifié avec certitude au format exploitable au moment de l'écriture — les
  plafonds d'emplois par programme existent dans les documents PLF (PAP) mais
