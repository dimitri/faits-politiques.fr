...
// du site que internal/sitegen sait recopier plutôt que reconstruire (voir
// internal/sitegen/cache.go). Pas dérivée automatiquement des requêtes Go — un
// static-analysis qui lirait internal/sitegen pour la déduire serait plus élégant,
...
// dans internal/sitegen — un oubli ici ne casse rien dans l'immédiat, mais fait
// recopier une page qui aurait dû être reconstruite.
var Sections = map[string][]string{
	// internal/sitegen/lieux_pages.go (chargerPagesCommunes, chargerPagesEPCI) et la
	// part de internal/sitegen/carte_situation.go qui alimente PageCommune.Situation.
	...
	// internal/sitegen/scrutins.go (buildScrutins et ses chargements associés :
