// Package presidentielle charge l'élection présidentielle française telle que le
// Conseil constitutionnel la proclame, la population par âge qui sert de
// dénominateur, et la participation comparée des autres pays.
...
// Lecteur XLSX minimal, écrit sur la bibliothèque standard.
//
// Motif : deux des trois sources de ce paquet sont des classeurs Excel, et
// aucune n'est disponible en CSV. Une dépendance externe pour lire quelques
// milliers de cellules coûterait plus cher, en surface d'audit, que les cent
// lignes ci-dessous. On ne gère que ce dont on a besoin : chaînes partagées,
// valeurs numériques, et lecture d'une feuille par son nom.
