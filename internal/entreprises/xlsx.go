...
// internal/macro/xlsx.go (voir son commentaire d'en-tête) : une centaine de
// lignes dupliquées plutôt qu'une dépendance entre deux paquets sans rapport.
package entreprises
...
// la colonne étant sa lettre ("A", "B"...). Les libellés d'en-tête d'Ésane
// sont parfois coupés d'un saut de ligne dans la cellule : les espaces (sauts
// de ligne compris) sont normalisés en un seul espace, pour que les libellés
// se comparent par simple égalité de chaîne.
